...
def load_basic_models(args,index):
    ...
    elif 'vgg' in current_model_type.lower(): 
        local_model = globals()[current_model_type](args.apply_trainable_layer)
    else:
    ...
    #local_model_optimizer = torch.optim.AdamW(list(local_model.parameters()), lr=args.main_lr, weight_decay=0.01)
