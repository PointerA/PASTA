...
class CNN4FashionMnist(nn.Module):
# ----------------------------------------------------------------
#         Layer (type)               Output Shape         Param #
# ================================================================
#             Conv2d-1           [-1, 16, 14, 28]             144
#               ReLU-2           [-1, 16, 14, 28]               0
#        BatchNorm2d-3           [-1, 16, 14, 28]              32
#          MaxPool2d-4            [-1, 16, 7, 14]               0
#            Dropout-5            [-1, 16, 7, 14]               0
#             Conv2d-6            [-1, 32, 7, 14]           4,608
#               ReLU-7            [-1, 32, 7, 14]               0
#        BatchNorm2d-8            [-1, 32, 7, 14]              64
#          MaxPool2d-9             [-1, 32, 3, 4]               0
#           Dropout-10             [-1, 32, 3, 4]               0
#            Linear-11                   [-1, 10]           3,840
#              ReLU-12                   [-1, 10]               0
...
# ----------------------------------------------------------------
    def __init__(self, output_dim, bn=True):
        ...
        self.body1 = nn.Sequential(
            nn.Conv2d(1, 16, kernel_size=3, padding=1, stride=1, bias=False),
            act(),
            nn.BatchNorm2d(16),
        ...
        self.body2 = nn.Sequential(
            ...
            act(),
            nn.BatchNorm2d(32),
            nn.MaxPool2d(kernel_size=(2, 3), stride=(2, 3), padding=0),
            nn.Dropout(self.drop_rate),
        )
        self.fc = nn.Sequential(
            nn.Linear(32 * 3 * 4, self.output_dim, bias=False),
            act(),
...
class SimpleCNN4Cifar10(nn.Module):
    def __init__(self, num_classes):
        super(SimpleCNN4Cifar10, self).__init__()
        self.conv1 = nn.Conv2d(3, 6, 5)
        self.pool = nn.MaxPool2d(2, 2)
        self.conv2 = nn.Conv2d(6, 16, 3)
        self.fc1 = nn.Linear(16*2*6, 120)
...
#         Layer (type)               Output Shape         Param #
# ================================================================
#             Conv2d-1           [-1, 16, 16, 32]             432
#               ReLU-2           [-1, 16, 16, 32]               0
#        BatchNorm2d-3           [-1, 16, 16, 32]              32
#          MaxPool2d-4            [-1, 16, 8, 16]               0
#            Dropout-5            [-1, 16, 8, 16]               0
#             Conv2d-6            [-1, 32, 8, 16]           4,608
#               ReLU-7            [-1, 32, 8, 16]               0
#        BatchNorm2d-8            [-1, 32, 8, 16]              64
#          MaxPool2d-9             [-1, 32, 4, 5]               0
#           Dropout-10             [-1, 32, 4, 5]               0
#            Linear-11                   [-1, 10]           6,400
#              ReLU-12                   [-1, 10]               0
#       BatchNorm1d-13                   [-1, 10]              20
#           Dropout-14                   [-1, 10]               0
# ================================================================
...
# ----------------------------------------------------------------
    def __init__(self, output_dim, bn=True):
        ...
        self.fc = nn.Sequential(
            nn.Linear(32 * 4 * 5, self.output_dim, bias=False),
            act(),
            nn.BatchNorm1d(self.output_dim),
            nn.Dropout(0.5),
        )
...
class CNN_3(nn.Module):
    def __init__(self, output_dim, bn=True):
        ...
        # )
        self.fc = nn.Sequential(
            nn.Linear(32*2*6, self.output_dim, bias=False),
            act(),
            nn.BatchNorm1d(self.output_dim),
            nn.Dropout(0.5),
        )
