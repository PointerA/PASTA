...
communication_protocol_list = ['FedSGD','FedBCD_p','FedBCD_s','CELU','Quantization','Topk','ours','FlexVFL']
...
def load_basic_configs(config_file_name, args):
    ...
    args.maximun_of_batch_to_send = communication_protocol_dict['cache_size'] if ('cache_size' in communication_protocol_dict) else 3 #ours
